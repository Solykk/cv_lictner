    ...
    public void start(Stage stage) throws Exception {
        ...
        button.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                if (stageForChat == null || !stageForChat.isShowing()) {
        ...
        button1.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                if (stageForChat4 == null || !stageForChat4.isShowing()) {
        ...
        button2.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                if (stageForChat5 == null || !stageForChat5.isShowing()) {
        ...
        button3.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                if (stageForChat6 == null || !stageForChat6.isShowing()) {
        ...
        button4.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                if (stageForChat7 == null || !stageForChat7.isShowing()) {
